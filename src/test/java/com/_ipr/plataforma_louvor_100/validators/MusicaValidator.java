...
public class MusicaValidator {
    ...
    public static void validaMusicaDomainMapper(Musica comparacao1, MusicaDto comparacao2) {
        ...
        Assertions.assertEquals(comparacao1.getDificuldade(), comparacao2.dificuldade());
    ...
    public static void validaMusicasController(ResultActions resultado, int indexList, MusicaEntity comparacao) throws Exception {
    ...
    public static void validaMusicaDtoMapper(MusicaDto resultado, Musica comparacao) {
        ...
        Assertions.assertEquals(resultado.dificuldade(), comparacao.getDificuldade());
